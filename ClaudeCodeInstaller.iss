...
Source: "启动界面.bat"; DestDir: "{app}"; Flags: ignoreversion
...
Name: "{group}\Claude Code - 启动助手"; Filename: "{app}\启动界面.bat"; IconFilename: "{sys}\shell32.dll"; IconIndex: 14
...
Name: "{commondesktop}\Claude Code 安装与配置"; Filename: "{app}\启动界面.bat"; IconFilename: "{sys}\shell32.dll"; IconIndex: 14; Tasks: desktopicon

[Run]
Filename: "{app}\启动界面.bat"; Description: "启动 Claude Code 安装与 API 配置助手"; Flags: postinstall shellexec nowait
